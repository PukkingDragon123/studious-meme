...
const RESEARCH = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'f.deep', name: 'DEEP SOUNDING', cost: 16, need: ['f.sewer', 'f.ocean'], line: 'OPENS THE SUMP AND THE TRENCH', grant: { site: ['sump', 'trench'] } },
    ],
  },
];
const RES_NODE = {};
...
const Research = {
  ...
  zoneOpen(id) { return id === 'glades' || this.granted('zone').has(id); },
