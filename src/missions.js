...
const ARTIFACTS = [
  ...
  { id: 'rivet', stage: 'gate', name: 'A BRIDGE RIVET', line: 'ONE OF SIX HUNDRED THOUSAND. IT CAME OUT WHEN YOU PULLED ON THE TOWER.',
    boon: '+12% SWIM SPEED IN CURRENT', col: '#e4713a', glyph: 'bolt', apply: P => { P.st.speed *= 1.12; } },
...
const MISSIONS = {
  ...
  gate:        { title: 'UNDER THE BRIDGE', line: 'KILL A BOSS', kind: 'boss', target: 1 },
  // ---- ZONE 3 ----
...
const STORY = {
  ...
  sump: ['IT IS AT THE WHARF. THERE ARE FOUR THOUSAND PEOPLE AT THE WHARF.', 'CLEAR THE FLOATS. CLEAR ALL OF THEM.',
    'THE SEA LIONS HAVE GONE. THEY DO NOT DO THAT.'],
  outfall: ['IT IS IN THE BAY NOW. OPEN WATER, COLD, AND IT DOES NOT CARE.', 'IT IS WORKING THE SHIPPING CHANNEL.',
    'THE BAY IS ITS. WE ARE NOT GETTING IT BACK.'],
  gate: ['IT IS UNDER THE BRIDGE. THAT IS THE LAST NARROW WATER BEFORE THE PACIFIC.', 'SOMETHING ELSE LIVES IN THE STRAIT.',
    'WHATEVER WAS HOLDING THE GATE IS NOT HOLDING IT NOW.'],
  // ---- ZONE 3 ----
